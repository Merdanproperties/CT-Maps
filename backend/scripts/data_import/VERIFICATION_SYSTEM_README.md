...
```bash
cd backend
python -m scripts.data_import.automated_cama_verification --all
```

### Verify Specific Town
```bash
python -m scripts.data_import.automated_cama_verification --municipality Bridgeport
```

### Verify Before Importing New Town
```bash
python -m scripts.data_import.automated_cama_verification --before-import NewTown
```
...
```bash
python -m scripts.data_import.cama_update --municipality Bridgeport
```
...
### Verify Specific Town
```bash
python -m scripts.data_import.automated_cama_verification --municipality <TOWN>
```

### Verify Before Import
```bash
python -m scripts.data_import.automated_cama_verification --before-import <NEW_TOWN>
```

### Verify After Import
```bash
python -m scripts.data_import.automated_cama_verification --after-import <NEW_TOWN>
```
...
2. Run update: `python -m scripts.data_import.cama_update --municipality <TOWN>`
3. Re-verify: `python -m scripts.data_import.automated_cama_verification --municipality <TOWN>`
