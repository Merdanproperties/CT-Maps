...
- [ ] **Verify all existing towns** (0% mismatch required)
  - Run: `python -m scripts.data_import.automated_cama_verification --before-import <NEW_TOWN>`
...
- [ ] **Verify new town** (0% mismatch required)
  - Run: `python -m scripts.data_import.automated_cama_verification --municipality <TOWN>`
  - New town must have 0% mismatch rate
  - If mismatches found, fix immediately

- [ ] **Re-verify all existing towns** (ensure no corruption)
  - Run: `python -m scripts.data_import.automated_cama_verification --all`
