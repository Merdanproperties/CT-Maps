...
Reference: See IMPORT_TOWN_OPTIMIZED_REFERENCE.md in this folder
(backend/scripts/data_import/134_towns_output/) or Documentation/guides/ for
...
# #region agent log
# Project root is 5 levels up (script in backend/scripts/data_import/134_towns_output/)
...
# Backend is 4 levels up (script in backend/scripts/data_import/134_towns_output/)
