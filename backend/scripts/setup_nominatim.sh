...
echo "============================================================"
echo "Setting Up Local Nominatim Instance"
echo "============================================================"
...
echo ""
echo "⚠️  This is a long-running process (2-4 hours)"
echo "   You can check progress with: docker logs -f nominatim"
echo ""
...
echo "  This will download and process Connecticut map data"
